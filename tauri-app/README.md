# 🎙️ KT Recorder Tauri App (v0.3.0-dev)
...
│   ├─ get_config — парсит ~/.config/kt-recorder/config.sh   │
...
npm run tauri:build
# результат: src-tauri/target/release/bundle/dmg/KT Recorder_0.3.0_x64.dmg
```
